 ...
 */
final readonly class WeatherModelInference
{
    /**
    ...
    public function predict(array $features): WeatherPrediction
    {
        ...
        $output = $this->mlp->forward($normalized);
