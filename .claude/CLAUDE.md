# Claude Code Instructions - CVVFCM Project
...
2. **Search First:** Before creating a new component or style, search the codebase to ensure a similar one doesn't already exist. Reusability is key.
